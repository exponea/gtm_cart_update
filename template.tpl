...
{
  "displayName": "Exponea tracking of cart_update event",
  "categories": ["ANALYTICS", "CONVERSIONS", "EXPERIMENTATION"],
  "description": "Exponea tracking of the cart_update event.",
  "securityGroups": [],
...
var exponea_track = callInWindow('exponea.track', "cart_update", {
...
Created on 19/12/2019, 14:11:34
